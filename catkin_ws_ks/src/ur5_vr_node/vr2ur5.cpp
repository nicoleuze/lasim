...
class vr2ur5 {
    public:
        ...
        goal_sub = nh.subscribe<sensor_msgs::JointState>("/socket_goalState", 1, &vr2ur5::goalState_Callback, this);
        goal_msg.position.resize(6);
        goal_msg.name.reserve(6);

        current_joints_sub = nh.subscribe<sensor_msgs::JointState>("/joint_states", 1, &vr2ur5::current_joints_Callback, this);
